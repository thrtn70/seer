...
/// Resolves a path to a bundled GGUF model.
///
/// Resolution order:
/// 1. `Bundle.main` resource — production `.app` (model in `Contents/Resources/`).
/// 2. Dev fallback — `<devDirectory>/<filename>` (e.g. `vendor/…` relative to the repo
